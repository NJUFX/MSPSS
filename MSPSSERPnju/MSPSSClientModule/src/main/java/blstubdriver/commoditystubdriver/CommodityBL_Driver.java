...
public class CommodityBL_Driver {
  private  static final CommodityVO cvo1 = new CommodityVO("吊灯","蓝色","12138",1,2);
  private  static final CommodityVO cvo2 = new CommodityVO("台灯","红色","12139",2,2);
  ...
  private static final ClassificationVO classificationVO = new ClassificationVO("12138","台灯");
  @Test
    public void drive(){
        ...
        //5
        Iterator<CommodityVO> commodityVOS = commodityService.searchCommodity(fvo);
