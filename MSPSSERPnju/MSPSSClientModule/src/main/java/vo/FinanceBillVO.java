...
/**
 * Description: 收款单 付款单
 * Created by Hanxinhu at 20:01 2017/11/21/021
 */
public class FinanceBillVO {
    ...
    public FinanceBillVO(String ID,UserVO operator,ArrayList<FinanceItemVO> list, BillStatus status
       , double sum, UserVO managerVO,FinanceBillType type,
