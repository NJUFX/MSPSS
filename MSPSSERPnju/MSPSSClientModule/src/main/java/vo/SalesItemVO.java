...
/**
 * Description: 进货单 和 销售单的 单项商品相关的信息 Created by Hanxinhu at 22:27 2017/11/27/027
 */
public class SalesItemVO {
	...
	public String id;
	/**
	 * 单价 在进货单里默认为商品的进价 在销售单里默认为商品的零售价 可以修改 修改后的单价 在通过审批后自动更新最近进价 和 最近零售价
	 * 同时在通过审批后自动更新
	 */
	public double price;
	...
	public String getTotal() {
		return Double.toString(price * number);
	}
}
