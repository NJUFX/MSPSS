...
| 开发包图                      | 依赖的其他开发包                                |
| ------------------------- | --------------------------------------- |
| main                      | userblservice、userblimpl、util、vo、status |
| userui                    | userblservice、userblimpl、util、vo、status |
| userblservice             | vo、util、status                          |
| userblimpl                | util、status、vo                          |
| userdataservice           | util、po                                 |
| userdata                  |                                         |
| logui                     |                                         |
| logblservice              |                                         |
| logbl                     |                                         |
...
| generalaccountdata        |                                         |
| customerui                | customerlservice、vo、util、customerblimpl |
| customerblservice         | util、vo                                 |
| customerblimpl            | util、vo                                 |
| customerdataservice       | util、po                                 |
| customerdata              |                                         |
| vo                        |                                         |
| po                        |                                         |
| util                      |                                         |
...
| commoditybl    | 负责实现商品所需要的业务   |
| stockbl        | 负责实现库存所需要的业务   |
| billbl         | 负责实现订单所需要的业务   |
| promotionbl    | 负责实现促销策略所需要的业务 |
| logbl          | 负责实现日志所需要的业务   |
| tablebl        | 负责实现查看报表所需要的业务 |
| accountgeneral | 负责实现期初建账所需要的业务 |
| accountbl      | 负责实现银行账户所需要的业务 |
...
表5.3.2-8 generalaccountbl 的接口规范
