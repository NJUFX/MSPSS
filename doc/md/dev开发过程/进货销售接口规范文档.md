...
| 服务名                                      | 服务   | 服务                                       |
| ---------------------------------------- | ---- | ---------------------------------------- |
| StockSellerBLService.createPurchaseList  | 语法   | public boolean createPurchaseList(String supplier, String store, String worker, ArrayList< String > proList, String sum, String remark); |
|                                          | 前置条件 | 输入的信息符合规范                                |
...
| StockSellerBLService.createProductsList  | 语法   | public ArrayList< String > createProductsList(String ID, String name, String type, String quantity, String price, String sum, String remark); |
|                                          | 前置条件 | 输入的信息符合规范                                |
|                                          | 后置条件 | 返回一个商品列表                                 |