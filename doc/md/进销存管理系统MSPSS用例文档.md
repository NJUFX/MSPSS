...
| **优先级**  | 高                                        |             |            |
| **正常流程** | 1.  选择制定销售单。<br />       2. 新建一个销售单包括：包括：**单据编号**，**客户**，**业务员**，**操作员**，**仓库，出货商品清单，折让前总额，折让，使用代金卷金额，折让后总额，备注**。出货商品清单中要显示商品的**编号，，**型号**，数量**，单价**（默认为商品信息里的销售价，可修改）**，金额（自动生成），商品备注。3.财务人员从商品选择界面选择名称<br>4.系统自动生成金额<br>5. 进货销售人员确认生成单据。<br />6.系统生成单据，并提示新建成功 |             |            |
