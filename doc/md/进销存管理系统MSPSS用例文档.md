...
| **扩展流程**    | 1.2a该节点下已经存在商品<br>  1.系统提示该节点已存在商品，该节点不可选择<br>2.返回上一操作界面<br>1.3a  系统中已经存在该分类<br>1.系统提示已经存在该分类<br>2.返回上一操作界面<br>1.5a分类信息有误<br>1.提示重新输入或取消该操作<br>2.2a该节点下已经存在商品或者子分类<br>  1.系统提示该分类下存在商品和子分类，无法选择<br> |
| **特殊需求**    | 分类的名称长度小于16                              |
