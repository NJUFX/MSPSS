...
| **优先级**     |                                          |
| **正常流程**    | 1、财务人员调出账户信息<br>2、系统返回账户的余额和名称，并且等待财务人员的下一步操作<br>3、财务人员输入对账户的修改并保存<br>4、系统保存修改<br> |
| **扩展流程**    | 3a、新增或修改后的账户名称与已有账户名称同名   <br>  1、系统提示非法名称并且强制进行重新输入 |
| **特殊需求**    | 账户余额不能修改，并且提供模糊查询的选项                     |
...
| **扩展流程**    | 1a、金额为负<br>   1、系统警告，并强制操作员重新修改金额        |
| **特殊需求**    | 金额不能为负，审批结束之后财务人员会受到提示信息                 |
...
| **扩展流程**    | 1a、转账金额为负<br>    1、系统警告，并强制操作员重新修改金额     |
| **特殊需求**    | 转账金额不能为负                                 |
...
| **扩展流程**    | 1a、金额为负<br>    1、系统警告，并强制操作员重新修改金额<br>   |
| **特殊需求**    | 金额不能为负，所有表单均可以导出<br>                     |
...
| **扩展流程**    | 1a、账户名称重复<br>    1、系统警告，并强制操作员重新修改名称     |
| **特殊需求**    | 之后的一切操作将会改变系统里的信息，但不会改变期初信息。期初信息随时可查     |
